...
//  CampgroundManager
//
//  Created by Frank Cipolla on 4/4/17.
...
class ReservationServiceTests: XCTestCase {
  ...
  func testReserveCampSitePositiveNumberOfDays() {
    let camper = camperService.addCamper("Johnny Appleseed", phoneNumber: "408-455-1234")!
    ...
    XCTAssertTrue(result.error?.userInfo["Problem"] as? String == "Invalid number of days",
